...
if (dir.exists("/Users/pierre.jacquet/Library/CloudStorage/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Tables")) {
  table_dir <- "/Users/pierre.jacquet/Library/CloudStorage/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Tables"
} else if (dir.exists("C:/Users/PJacquet/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Tables")) {
  table_dir <- "C:/Users/PJacquet/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Tables"
} else {
  stop("Prior Predictive Checks_Tables directory not found.")
}

if (dir.exists("/Users/pierre.jacquet/Library/CloudStorage/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Figures")) {
  fig_dir <- "/Users/pierre.jacquet/Library/CloudStorage/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Figures"
} else if (dir.exists("C:/Users/PJacquet/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Figures")) {
  fig_dir <- "C:/Users/PJacquet/Dropbox/DGAEFS/AXIS 0_COLLABORATORS/Heloise Young/Child Development/Short-term mindset/RI-CLPM/Model_3/Prior Predictive Checks_Figures"
} else {
...
temporal_stat_map <- tribble(
  ...
  # late outcomes
  "mating_risky",    "mating.behaviour.z",         "risky.health.behaviour.z",
  "mating_adhd15",   "mating.behaviour.z",         "Adhd_15y.z",
  "mating_ext15",    "mating.behaviour.z",         "Ext_15y.z",
  "mating_int15",    "mating.behaviour.z",         "Int_15y.z",
  "risky_adhd15",    "risky.health.behaviour.z",   "Adhd_15y.z",
  "risky_ext15",     "risky.health.behaviour.z",   "Ext_15y.z",
  "risky_int15",     "risky.health.behaviour.z",   "Int_15y.z"
)
...
check_prior_implausibility <- function(dat, sex_value, dataset_id, imputation) {
  ...
  tibble(
    ...
    any_outcome_abs_gt_6 = any(
      abs(dat$mating.behaviour.z) > 6 |
        abs(dat$risky.health.behaviour.z) > 6,
      na.rm = TRUE
    ),
    prop_outcome_abs_gt_4 = mean(
      abs(c(dat$mating.behaviour.z, dat$risky.health.behaviour.z)) > 4,
      na.rm = TRUE
    ),
    ...
    late_outcome_mean_abs_corr = mean(c(
      abs(safe_cor(dat$mating.behaviour.z, dat$Adhd_15y.z)),
      abs(safe_cor(dat$mating.behaviour.z, dat$Ext_15y.z)),
      abs(safe_cor(dat$mating.behaviour.z, dat$Int_15y.z)),
      abs(safe_cor(dat$risky.health.behaviour.z, dat$Adhd_15y.z)),
      abs(safe_cor(dat$risky.health.behaviour.z, dat$Ext_15y.z)),
      abs(safe_cor(dat$risky.health.behaviour.z, dat$Int_15y.z)),
      abs(safe_cor(dat$mating.behaviour.z, dat$risky.health.behaviour.z))
    ), na.rm = TRUE)
  )
}
...
plot_prior_density_lhs <- make_density_plot(
  dat = density_data,
  vars_keep = c("mating.behaviour.z", "risky.health.behaviour.z"),
  title_text = "Prior predictive densities – mating and risky health",
  facet_levels = c("Mating", "Risky health")
)
...
plot_prior_scatter_lhs <- make_regression_plot(
  data_block = "psych15_outcomes",
  title_text = "Prior predictive check – regression structure (psychopathology at age 15 → mating / risky health)"
)
...
save_plot(plot_prior_density_lhs,    "prior_density_lhs_mi",          8, 7)
...
save_plot(plot_prior_scatter_lhs,    "plot_prior_scatter_lhs_mi",     20, 8)
